...
Tumblr Widget allows you to display the contents of a Tumblr in any widget-enabled area of your WordPress blog.
...
Use CSS. You can add targeted style rules to your `style.css` file, in your theme folder. Each post is a <li> with the class "tumblr_post." Each post also has the class of its post type: "quote", "link", "conversation", "regular", "photo", "audio", or "video".
